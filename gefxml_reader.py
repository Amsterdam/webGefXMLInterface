...
#            36-40: for future use
        ...
        self.metadata_from_gef(gefFile, fromFile=False) # TODO: dit is nieuw
...
#        self.data = pd.read_fwf(StringIO(self.data), header=None)         
    ...
    def plot(self, path='./output', returnFig=False): # TODO: dit is nieuw
